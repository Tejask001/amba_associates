...
<body>
    <div class="container">
        <form action="./saveUpdatedClient.php" method="POST" class="needs-validation" id="form" novalidate>
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="client-phone" name="client-phone"
                        placeholder="Phone Number" value="<?php echo htmlspecialchars($row['phone']); ?>"
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="client-address" name="client-address"
                        placeholder="Address" value="<?php echo htmlspecialchars($row['address']); ?>" required>
                    <div class="invalid-feedback">
            ...
            <div class="row mb-3">
                <div class="col-md-3">
                    <label for="comp-chemical-license">Client Chemical License *</label>
