        ...
        <form id="updateProductForm" action="./saveProduct.php" method="post">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="chemical_name" class="form-control to-fill"
                        value="<?php echo $product['chemical_name']; ?>" required>
                </div>
                <div class="col-md-3">
                    <label for="chemical_size" class="form-label">Chemical Size</label>
                    <input type="text" name="chemical_size" class="form-control to-fill"
                        value="<?php echo $product['chemical_size']; ?>" required>
                </div>
            </div>
